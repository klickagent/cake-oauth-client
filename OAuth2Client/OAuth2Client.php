...
class OAuth2Client
{
	...
	*/
	 ...
	 * @return array
	 */
	public function fetch($protected_resource_url, $parameters = array(), $http_method = self::HTTP_METHOD_POST, array $http_headers = array(), $form_content_type = self::HTTP_FORM_CONTENT_TYPE_MULTIPART)
	{
		if ($this->access_token) {
			switch ($this->access_token_type) {
				...
				case self::ACCESS_TOKEN_BEARER:
					...
					//Authroization Header seems to be filtered! => send X-Auth!!!
					$http_headers['X-Authorization'] = 'Bearer ' . $this->access_token;
					break;
